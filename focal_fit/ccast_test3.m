...
shome = '/asl/data/cris/ccast/test3';
...
opts.LW_sfile = './SAinv_test3_LW.mat';
opts.MW_sfile = './SAinv_test3_MW.mat';
opts.SW_sfile = './SAinv_test3_SW.mat';

% time-domain FIR filter 
opts.NF_file = '/asl/packages/ccast/inst_data/FIR_19_Mar_2012.txt';

% NEdN principal component filter
opts.nedn_filt = '/asl/packages/ccast/inst_data/nedn_filt_HR.mat';
