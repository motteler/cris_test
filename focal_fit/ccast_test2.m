...
shome = '/asl/data/cris/ccast/test2';
...
opts.version = 'jpss1';    % current active CrIS
...
opts.LW_sfile = './SAinv_test2_LW.mat';
opts.MW_sfile = './SAinv_test2_MW.mat';
opts.SW_sfile = './SAinv_test2_SW.mat';
